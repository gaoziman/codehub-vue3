<template>
  <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-col items-center">
      <!-- 博主头像 -->
      <img class="w-16 h-16 mb-3 rounded-full shadow"
           :src="blogSettingStore.blogSetting.avatar" alt="头像"/>
      <!-- 博主昵称 -->
      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ blogSettingStore.blogSetting.author }}</h5>
      <!-- 介绍语 -->
      <span class="text-sm text-gray-500 dark:text-gray-400">{{ blogSettingStore.blogSetting.introduction }}</span>
      <!-- 第三方平台主页跳转（如 GitHub 等） -->
      <div class="flex justify-center gap-2">
        <!-- GitHub -->
        <svg @click="jump(blogSettingStore.blogSetting.githubHomepage)" v-if="blogSettingStore.blogSetting.githubHomepage" t="1698029949662"  data-tooltip-placement="bottom"
             class="icon w-7 h-7  mt-5" viewBox="0 0 1024 1024"  version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="1447"  width="200" height="200" style="cursor: pointer">
        ...
        <!-- Gitee -->
        <svg @click="jump(blogSettingStore.blogSetting.giteeHomepage)" v-if="blogSettingStore.blogSetting.giteeHomepage" t="1698030969736" data-tooltip-placement="bottom"
             class="icon w-7 h-7  mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="2438" width="200" height="200" style="cursor: pointer">
          <path
        ...
        <!-- 知乎 -->
        <svg @click="jump(blogSettingStore.blogSetting.zhihuHomepage)" v-if="blogSettingStore.blogSetting.zhihuHomepage" t="1698031258903"  data-tooltip-placement="bottom"
             class="icon w-7 h-7  mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="3419" width="200" height="200" style="cursor: pointer">
        ...
        <!-- CSDN -->
        <svg @click="jump(blogSettingStore.blogSetting.csdnHomepage)" v-if="blogSettingStore.blogSetting.csdnHomepage" t="1698031311586"  data-tooltip-placement="bottom"
             class="icon w-7 h-7  mt-5" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="4386" width="200" height="200" style="cursor: pointer">
          <path
